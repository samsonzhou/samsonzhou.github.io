...
\textbf{Decidability}
\begin{itemize}
	\item Definition of decidability and whether certain problems are decidable
	%\item Graph coloring
...
\begin{itemize}
	\item You should know Karp-Rabin fingerprints and their purposes
	\item You should know hashing and chaining
	\item High-level intuition for PageRank
\end{itemize}
...
\begin{enumerate}
	\item Practice previous final exams
  \item Practice problems for linear programming (and dual linear programs)
	\item The practice homework associated with the last week of lectures on NP-hardness reductions
	\item The lecture notes for randomized algorithms
