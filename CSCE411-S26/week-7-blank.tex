...
\begin{document}
	...
	\week{7: Finishing DFS; Minimum Spanning Trees}{February 24, 2026}
	...
	For an undirected graph $G = (V,E)$ a connected component is a maximal subgraph $S$ in which every node in $S$ is \hide{reachable from every other } \\
