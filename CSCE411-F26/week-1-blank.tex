...
\lecture{1: Intro, Asymptotic Runtimes, Divide and Conquer}{August 25, 2026}

\paragraph{Course Logistics}

\begin{itemize}
\item Read section 2.3, chapter 4, and chapter 30 for first week of classes.
\item Read (or skim) chapters 1-3 to ensure familiarity with prerequisites
\item HW 1, intro video, and syllabus quiz are due Fri, Sep 4.
\end{itemize}
